...
public class Main {
    ...
    private static void runDecisionTree() {
        ...
        System.out.println("     --> maximum tree depth");
    
        System.out.println("\nTODO: Implement Decision Tree");
    
        // TODO: Implement the Decision Tree here
    }
    ...
    private static void runNaiveBayes() {
        ...
        try {
            ...
            nbPreprocessor.preprocess("income", 0.8, 42, false);  // normalize = false
    ...
    private static void printResults() {
        ...
        System.out.println("*****************************");
        // TODO: Have to print out the comparison table
        if (!dataLoaded) {
            System.out.println("No data loaded yet.");
        } else {
            System.out.println("Data is loaded and ready for training models.");
        }
    }
}
